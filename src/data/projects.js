...
export const projects = [
  ...
  },
  {
    ...
    description: '시니어 주거 시설의 고급스러운 이미지를 웹에 담아냈습니다. 누구나 쓰기 편하도록 <b>웹 접근성</b>을 꼼꼼히 챙겼고, 어떤 기기에서 봐도 깔끔하게 보이도록 신경 써서 작업했습니다.',
    tech: ['HTML5', 'SCSS', 'JavaScript'],
    link: 'https://www.lottesrc.com/vl',
    image: lotteImg,
    background: '#ffffff',
    thumbnailHeight: '3.4rem',
    problem: '글자가 잘 보여야 하는 시니어 타겟이라 폰트 크기나 색상 대비에 신경 쓸 게 많았습니다. 또 모바일이나 태블릿마다 화면이 깨지지 않게 잡는 작업이 중요했습니다.',
    action: '접근성 지침을 하나하나 체크하며 누구나 이용하기 좋게 개선했고, <b>SCSS로 반응형 구조</b>를 체계적으로 잡아 기기마다 화면이 틀어지는 걸 원천적으로 막았습니다. 자주 쓰는 요소들은 컴포넌트로 만들어 팀원들이 편하게 가져다 쓰게 했습니다.',
